...
const HomeView: React.FC<HomeViewProps> = ({ role }) => {
    const isManagement = role === 'CEO' || role === 'GERENTE';
    ...
    return (
        <div className="view-container fade-in">
            <div className="view-header">
                <div>
                    <h1>Dashboard</h1>
                    <p className="subtitle">Bienvenido de vuelta, {role}</p>
                </div>
            </div>
            ...
            {isManagement ? (
                ...
                <div className="card text-center" style={{ padding: '3rem' }}>
                    ...
                    <p className="text-muted" style={{ marginTop: '1rem' }}>
                        Tus tareas y actividades recientes aparecerán aquí según tu rol ({role.replace('EMPLEADO_', '')}).
                    </p>
                </div>
            )}
        </div>
